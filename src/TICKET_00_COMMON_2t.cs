...
namespace Parser.src
{
    public class TICKET_00_COMMON
    {
        ...
        public static void CmHandleError(string sMsgTitle, string sMsgBody)
        {
            ...
            if (m_sErrorMsg != sMsgTitle+sMsgBody)
            {
                m_sErrorMsg = sMsgTitle + sMsgBody;
    ...
    ;
            if (oMsg != null)
            {
                oMsg.Subject = ERRHEAD + sMsgTitle + sMsgBody;
