Attribute VB_Name = "HELP02_MakeTicket_Task_3b"
'############################################################################################################
'## HELP01_MakeTicket_Task - VBA Code to create a Ticket task item                                         3b
'############################################################################################################
...
Public Sub Help_MakeTicket_Task(ByRef oMail As MailItem, _
                                     ...
                                     Optional ByRef sCause As String = "")
    ...
    If InStr(1, sTopic, "TechBldrs Quote ", vbTextCompare) > 0 Then
        ...
        oTask.Categories = TKT_CAT_QUOTED
    End If
    '-------------------------------------------------------------------------------------------
