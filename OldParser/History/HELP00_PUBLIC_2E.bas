Attribute VB_Name = "HELP00_PUBLIC_2E"
'############################################################################################################
'## HELP00_Public - VBA module that holds Public Constants and Variables common to many Ticket Builder    2D
'############################################################################################################
...
'Public m_fldrWaiting_DteLastActivity As Folder '-- folder to store all emails that come in while a ticket is open  '-- @J
