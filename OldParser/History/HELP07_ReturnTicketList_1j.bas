Attribute VB_Name = "HELP07_ReturnTicketList_1j"
'############################################################################################################
'## HELP07_ReturnTicketList - VBA Code to return a list of tickets                                         1j
'############################################################################################################
...
Public Function HELP_ReturnTicketList(ByRef oMail As Object) As Boolean
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "HELP07_ReturnTicketList:HELP_ReturnTicketList [" & err.Number & "] " & err.Description
