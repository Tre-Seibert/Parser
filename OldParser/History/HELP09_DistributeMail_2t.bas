Attribute VB_Name = "HELP09_DistributeMail_2t"
'############################################################################################################
...
Public Sub HELP_DistributeMail(ByRef sAssignee As String, _
    ...
    Exit Sub
ERRORHANDLER:
    HandleError "HELP09_DistributeMail:HELP_DistributeMail [" & Err.Number & "] " & Err.Description
...
Private Function DistributeMail_Init() As Boolean
    ...
    Exit Function
ERRORHANDLER:
    HandleError "HELP09_DistributeMail:DistributeMail_Init [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function FindAssignedTechs(ByRef fCalendar As Folder, _
    ...
    Exit Function
ERRORHANDLER:
    HandleError "HELP09_DistributeMail:FindAssignedTechs [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
'                        On Error GoTo 0
    ...
    Exit Function
ERRORHANDLER:
    HandleError "HELP09_DistributeMail:FindApptbyLabel [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function SendMailtoTechs(ByRef oMail As MailItem, _
    ...
    Exit Function
ERRORHANDLER:
    HandleError "HELP09_DistributeMail:SendMailtoTechs [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function SendMailtoAllTechs(ByRef oMail As MailItem, _
    ...
    Exit Function
ERRORHANDLER:
    HandleError "HELP09_DistributeMail:SendMailtoAllTechs [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function SendMailtoAssignee(ByRef sAssignee As String, _
    ...
    Exit Function
ERRORHANDLER:
    HandleError "HELP09_DistributeMail:SendMailtoAssignee [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
'    Next
    ...
    Exit Function
ERRORHANDLER:
    HandleError "HELP09_DistributeMail:SendMail [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
