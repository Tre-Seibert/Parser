Attribute VB_Name = "HELP04_MakeTicket_Time_1z"
'############################################################################################################
'## HELP03_MakeTicket_Time - VBA Code to create a Time appointment item                                    1z
'############################################################################################################
...
Public Function Help_MakeTicket_Time(ByRef oAppt As AppointmentItem, _
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "HELP04_MakeTicket_Time:Help_MakeTicket_Time [" & Err.Number & "] " & Err.Description
...
Private Sub CleanUp_Time(fTarget As Folder)
    ...
    Exit Sub
ERRORHANDLER:
    CmHandleError "HELP04_MakeTicket_Time:CleanUp_Time [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Sub
