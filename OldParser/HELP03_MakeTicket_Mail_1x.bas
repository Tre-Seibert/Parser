Attribute VB_Name = "HELP03_MakeTicket_Mail_1x"
'############################################################################################################
'## HELP02_MakeTicket_Mail - VBA Code to create a Mail mail/note item                                      1x
'############################################################################################################
...
'      oMail.Move fTarget
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "HELP03_MakeTicket_Mail:Help_MakeTicket_Mail [" & Err.Number & "] " & Err.Description & " >" & oMail.Subject
    If ERR_RESUME Then Resume Next
End Function


Sub moveMail(ByRef fTarget As folder, ByRef oMail As MailItem)
      oMail.Move fTarget
End Sub
