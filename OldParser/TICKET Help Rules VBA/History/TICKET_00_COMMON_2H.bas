Attribute VB_Name = "TICKET_00_COMMON_2H"
'##################################################################################################
'## TICKET_COMMON - Common Public Constants, Variables & Routines for the Ticket System          2G
'##################################################################################################
...
'----------------------------------------------------------------------------------------------------------
'-- Change_MessageClass_All - Sets the message class value for all items in the current folder.  The
...
'----------------------------------------------------------------------------------------------------------
Public Function Change_MessageClass_All(ByRef fldr As Folder, ByRef sMsgClass As String) As Integer
'Function Change_MessageClass_All(fldr, sMsgClass)
    Dim idx         'As Long
    Dim iCnt        'As Long
    Dim cItems      'As Items
    ...
    Exit Function
ERRORHANDLER:
    HandleError "Change_MessageClass_All [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
