Attribute VB_Name = "HELP07_ReturnTicketList_1h"
'############################################################################################################
'## HELP07_ReturnTicketList - VBA Code to return a list of tickets                                         1v
'############################################################################################################
...
Public Function HELP_ReturnTicketList(ByRef oMail As Object) As Boolean
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "In HELP07_ReturnTicketList:HELP_ReturnTicketList [" & Err.Number & "] " & Err.Description
