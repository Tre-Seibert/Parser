Attribute VB_Name = "HELP03_MakeTicket_Mail_1o"
'############################################################################################################
'## HELP02_MakeTicket_Mail - VBA Code to create a Mail mail/note item                                      1o
'############################################################################################################
...
Public Function Help_MakeTicket_Mail(ByRef oMail As MailItem, _
    ...
    Exit Function
ERRORHANDLER:
    HandleError "In Mod:Rtn HELP03_MakeTicket_Mail:Help_MakeTicket_Mail [" & Err.Number & "] " & Err.Description
