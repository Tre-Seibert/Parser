Attribute VB_Name = "HELP00_PUBLIC_1t"
'############################################################################################################
...
'-- These are User Defined fields and for consistency are also the name of the form object.
'-- COPY TO 2 PLACES: (A) Help System VBA code to create Time appointment item (B) TB_Ticket Form VBS
Public Const TIME_BILLABLE = ".Billable"
...
Public Const TIME_GRATIS = ".Gratis"
Public Const TIME_HOURS = ".Hours"
Public Const TIME_INVOICE_DESC = ".InvoiceDesc"
Public Const TIME_INVOICE_NUM = ".InvoiceNum"
Public Const TIME_JOB = ".Job"
Public Const TIME_REVIEWED = ".REVIEWED"
...
Public Sub HandleError(Optional ByRef sMsgBody As String = "Error Unknown")
    ...
    oMsg.Recipients.Add "TBPhoneAlerts@techBldrs.com"   '-- Cell phone alerts
