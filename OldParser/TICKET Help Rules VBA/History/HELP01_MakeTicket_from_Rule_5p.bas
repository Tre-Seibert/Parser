Attribute VB_Name = "HELP01_MakeTicket_from_Rule_5p"
'############################################################################################################
'## HELP01_MakeTicket_from_Rule - VBA Code launched from Outlook Rule                                      5p
'############################################################################################################
...
'    HeartBeat m_fldrTickets    '-- MOVED TO separate EXE nightly batch run
    ...
    Exit Sub
ERRORHANDLER:
    CmHandleError "In Mod:Rtn HELP01_MakeTicket_from_Rule:HELP_MakeTicket [" & Err.Number & "] " & Err.Description
...
Private Sub HELP_ProcessTime(ByRef oMtgReq As MeetingItem)
    ...
    Exit Sub
ERRORHANDLER:
    CmHandleError "In Mod:Rtn HELP01_MakeTicket_from_Rule:HELP_ProcessTime [" & Err.Number & "] " & Err.Description
End Sub
...
'        HELP_DistributeMail oTicket.UserProperties(TKT_ASSIGNEE), oEmail
    ...
    Exit Sub
ERRORHANDLER:
    CmHandleError "In Mod:Rtn HELP01_MakeTicket_from_Rule:HELP_ProcessEmail [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Sub
...
'    Set m_oSpeech = CreateObject("sapi.spvoice")
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "In Mod:Rtn HELP01_MakeTicket_from_Rule:HELP_MakeTicket_Init [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function Clean_Up_Subject(ByRef sTemp As String) As String
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "In Mod:Rtn HELP01_MakeTicket_from_Rule:Clean_Up_Subject [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function Parse_Ticket_Header(ByRef sSubject As String, _
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "In Mod:Rtn HELP01_MakeTicket_from_Rule:Parse_Ticket_Header [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function Parse_Ticket_Command(ByRef sSubject As String, _
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "In Mod:Rtn HELP01_MakeTicket_from_Rule:Parse_Ticket_Command [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
'        End If
    ...
    Exit Sub
ERRORHANDLER:
    CmHandleError "Error:HELP01_MakeTicket_from_Rule:Help_ProcessAllMail [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Sub
...
Private Function NextTicketNum(sClient As String) As String
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "Error:HELP01_MakeTicket_from_Rule:NextTicketNum [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
