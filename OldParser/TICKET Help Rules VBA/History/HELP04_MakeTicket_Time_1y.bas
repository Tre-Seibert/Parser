Attribute VB_Name = "HELP04_MakeTicket_Time_1y"
'############################################################################################################
'## HELP03_MakeTicket_Time - VBA Code to create a Time appointment item                                    1y
'############################################################################################################
...
Function Round15Minutes(dteTime)
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "HELP04_MakeTicket_Time:Round15Minutes [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
