Attribute VB_Name = "HELP01_MakeTicket_from_Rule_5h"
'############################################################################################################
...
'    Revive_Overdue_Tickets '-- MOVED TO separate EXE nightly batch run
    ...
    If ((InStr(1, oItem.MessageClass, MSGCLS_Note, vbTextCompare) > 0 Or _
        ...
        StrComp(oItem.MessageClass, MSGCLS_Reply, vbTextCompare) = 0) And _
        Not StrComp(oItem.MessageClass, "REPORT.IPM.Note.NDR", vbTextCompare) = 0) Then
...
'    HeartBeat m_fldrTickets    '-- MOVED TO separate EXE nightly batch run
    ...
    Exit Sub
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:HELP_MakeTicket [" & Err.Number & "] " & Err.Description
...
Private Sub HELP_ProcessTime(ByRef oMtgReq As MeetingItem)
    ...
    Exit Sub
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:HELP_ProcessTime [" & Err.Number & "] " & Err.Description
End Sub
...
'        sTopic = sSubject
    ...
    '-- Change the incoming mail to a Ticket Mail and move it to the Mail foler
    ...
    Exit Sub
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:HELP_ProcessEmail [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Sub
...
'    Set m_oSpeech = CreateObject("sapi.spvoice")
    ...
    Exit Function
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:HELP_MakeTicket_Init [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function Clean_Up_Subject(ByRef sTemp As String) As String
    ...
    Exit Function
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:Clean_Up_Subject [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function Parse_Ticket_Header(ByRef sSubject As String, _
    ...
    Exit Function
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:Parse_Ticket_Header [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function Parse_Ticket_Command(ByRef sSubject As String, _
    ...
    Exit Function
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:Parse_Ticket_Command [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
Private Function Find_Matching_Task(ByRef cItems As Items, _
    ...
    Exit Function
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:Find_Matching_Task [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
...
'        End If
    ...
    Exit Sub
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:Help_ProcessAllMail [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Sub
...
Private Function NextTicketNum(sClient As String) As String
    ...
    Exit Function
ERRORHANDLER:
    HandleError "+HELP01_MakeTicket_from_Rule:NextTicketNum [" & Err.Number & "] " & Err.Description
    If ERR_RESUME Then Resume Next
End Function
