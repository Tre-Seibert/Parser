Attribute VB_Name = "HELP09_DistributeMail_3b"
'############################################################################################################
'## HELP09_DistributeMail - VBA Code to distribute incoming notification to the Help Desk and Techs        3b
'##
...
Public Sub HELP_DistributeMail(ByRef sAssignee As String, _
    ...
    If Not blnIsItWorkTime Or blnNoHelpTechs Then
        ...
        Else
            ...
            '-- Send DutyWeek Teams Message
            SendMail oMail, "47624c95.tecmanage.com@amer.teams.ms", sReason
    ...
    Exit Sub
ERRORHANDLER:
    CmHandleError "HELP09_DistributeMail:HELP_DistributeMail [" & Err.Number & "] " & Err.Description & " >" & oMail.Subject
...
Private Function SendMailtoTechs(ByRef oMail As MailItem, _
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "HELP09_DistributeMail:SendMailtoTechs [" & Err.Number & "] " & Err.Description & " >" & oMail.Subject
    If ERR_RESUME Then Resume Next
End Function
...
Private Function SendMailtoAllTechs(ByRef oMail As MailItem, _
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "HELP09_DistributeMail:SendMailtoAllTechs [" & Err.Number & "] " & Err.Description & " >" & oMail.Subject
    If ERR_RESUME Then Resume Next
End Function
...
Private Function SendMailtoAssignee(ByRef sAssignee As String, _
    ...
    If sTechEmails <> "" Then
        ...
        If InStr(1, sTechEmails, oMail.SenderEmailAddress, vbTextCompare) = 0 And Left(oMail.SenderEmailAddress, 3) <> "/O=" Then
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "HELP09_DistributeMail:SendMailtoAssignee [" & Err.Number & "] " & Err.Description & " >" & oMail.Subject
    If ERR_RESUME Then Resume Next
End Function
...
'    Next
    ...
    Exit Function
ERRORHANDLER:
    CmHandleError "HELP09_DistributeMail:SendMail [" & Err.Number & "] " & Err.Description & " >" & oMail.Subject
    If ERR_RESUME Then Resume Next
End Function
...
Sub testsendtoteams()
    ...
    '-- Fill in the message
    With oMsg
        .To = "TestSender@xyz.com"
'        .SenderName = "testSenderName"
        .Subject = "Test Hello World"
        .Body = "hello world"
    End With
    
    SendMail oMsg, "47624c95.tecmanage.com@amer.teams.ms", "DutyWeek"
End Sub
